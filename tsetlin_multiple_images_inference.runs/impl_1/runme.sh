...
HD_PWD='D:/tsetlin_multiple_images_inference/tsetlin_multiple_images_inference.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design1_direct_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design1_direct_wrapper.tcl -notrace
