...
HD_PWD='D:/tsetlin_multiple_images_inference/tsetlin_multiple_images_inference.runs/design1_direct_axi_bram_ctrl_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design1_direct_axi_bram_ctrl_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design1_direct_axi_bram_ctrl_0_0.tcl
