...
HD_PWD='D:/tsetlin_multiple_images_inference/tsetlin_multiple_images_inference.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design1_direct_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design1_direct_wrapper.tcl
