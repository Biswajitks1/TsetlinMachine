...
design_libs=(xilinx_vip xpm axi_infrastructure_v1_1_0 axi_vip_v1_1_14 processing_system7_vip_v1_0_16 xil_defaultlib blk_mem_gen_v8_4_6 axi_bram_ctrl_v4_1_8 xlconstant_v1_1_7 lib_cdc_v1_0_2 proc_sys_reset_v5_0_13 smartconnect_v1_0 axi_register_slice_v2_1_28 axi_lite_ipif_v3_0_4 interrupt_control_v3_1_4 axi_gpio_v2_0_30)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.design1_direct xil_defaultlib.glbl -o design1_direct_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./design1_direct_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key design1_direct_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc design1_direct_simv.daidir vcs_lib c.obj)
