...
#
# Script generated by Vivado on Tue Sep 05 13:07:33 +0530 2023
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : design1_direct.sh
...
#
# Usage        : design1_direct.sh
#                design1_direct.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                design1_direct.sh [-reset_run]
#                design1_direct.sh [-reset_log]
#                design1_direct.sh [-help]
#
...
#                script (type 'design1_direct.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_14 -libname processing_system7_vip_v1_0_16 -libname xil_defaultlib -libname blk_mem_gen_v8_4_6 -libname axi_bram_ctrl_v4_1_8 -libname xlconstant_v1_1_7 -libname lib_cdc_v1_0_2 -libname proc_sys_reset_v5_0_13 -libname smartconnect_v1_0 -libname axi_register_slice_v2_1_28 -libname axi_lite_ipif_v3_0_4 -libname interrupt_control_v3_1_4 -libname axi_gpio_v2_0_30 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm axi_infrastructure_v1_1_0 axi_vip_v1_1_14 processing_system7_vip_v1_0_16 xil_defaultlib blk_mem_gen_v8_4_6 axi_bram_ctrl_v4_1_8 xlconstant_v1_1_7 lib_cdc_v1_0_2 proc_sys_reset_v5_0_13 smartconnect_v1_0 axi_register_slice_v2_1_28 axi_lite_ipif_v3_0_4 interrupt_control_v3_1_4 axi_gpio_v2_0_30)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "design1_direct.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./design1_direct.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.design1_direct xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.design1_direct -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log design1_direct_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./design1_direct.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: design1_direct.sh [-help]\n\
Usage: design1_direct.sh [-step]\n\
Usage: design1_direct.sh [-lib_map_path]\n\
Usage: design1_direct.sh [-reset_run]\n\
Usage: design1_direct.sh [-reset_log]\n\
Usage: design1_direct.sh [-keep_index]\n\
Usage: design1_direct.sh [-noclean_files]\n\n\
